...
#SBATCH --mail-user=mrwood01@wm.edu               # change this!
#SBATCH -o /sciclone/home/mrwood01/BIOCOMPUTING/lessons/lesson_08/logs/REPLACEME_03assemble_%j.out # change this!
#SBATCH -e /sciclone/home/mrwood01/BIOCOMPUTING/lessons/lesson_08/logs/REPLACEME_03assemble_%j.err # change this!
